package com.example.leandromarques.chatbotdoid.Adapter;
...
import com.example.leandromarques.chatbotdoid.R;

import java.util.List;

/**
 * Created by leandro.marques on 23/11/2016.
 */
...
public class ChatMessageAdapter extends ArrayAdapter<ChatMessage> {
    ...
    public ChatMessageAdapter(Context context, List<ChatMessage> data){
        super(context, R.layout.item_other_message, data);
    }
